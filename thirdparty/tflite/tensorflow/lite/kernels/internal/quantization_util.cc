...
void QuantizeMultiplierGreaterThanOne(double double_multiplier,
                                      ...
                                      int* left_shift) {
  TFLITE_CHECK_GT(double_multiplier, (double)1.);
...
void QuantizeMultiplierSmallerThanOneExp(double double_multiplier,
                                         int32_t* quantized_multiplier,
                                         int* left_shift) {
  TFLITE_CHECK_LT(double_multiplier, (double)1.);
  TFLITE_CHECK_GT(double_multiplier, (double)0.);
  int shift;
