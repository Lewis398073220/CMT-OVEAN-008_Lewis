...
/*!
  \def   Macro converts a int32_t fixed point to int16_t fixed point <1 with saturation
*/
#define WORD322WORD16(val)                                                                                             \
    ((((((val) >> (WORD32_BITS - WORD16_BITS - 1)) + 1) > (((_LONG)1 << WORD16_BITS) - 1)) && ((_LONG)(val) > 0))      \
         ? (int16_t)(_SHORT)(((_LONG)1 << (WORD16_BITS - 1)) - 1)                                                       \
         : (int16_t)(_SHORT)((((val) >> (WORD32_BITS - WORD16_BITS - 1)) + 1) >> 1))
...
/****************************************************************************/
/*!
  \brief   Does fractional integer division of int32_t arg1 by int16_t arg2


  \return fractional int16_t integer z = arg1(32bits)/arg2(16bits) , z not normalized
*/
int16_t Divide3216_Scale(int32_t  x,  /*!< i  : Numerator  */
                                   int16_t  y,  /*!< i  : Denominator*/
                                   int16_t *s); /*!< o  : Additional scalefactor difference*/

/****************************************************************************/
/*!
  \brief   Does fractional division of int16_t arg1 by int16_t arg2


  \return fractional Q15 int16_t z = arg1(Q15)/arg2(Q15)  with scaling s
*/
int16_t Divide1616_Scale(int16_t  x,  /*!< i  : Numerator*/
                                   int16_t  y,  /*!< i  : Denominator*/
                                   int16_t *s); /*!< o  : Additional scalefactor difference*/
...
/*!
  ...
  of 1/32, table exp2w_tab_long_lc3 the log2 for 0 to 1/32 in steps
  of 1/1024, table exp2x_tab_long_lc3 the log2 for 0 to 1/1024 in
...
int16_t compMantExp16Unorm(int16_t m1, int16_t e1, int16_t m2, int16_t e2);
...
int32_t Isqrt(int32_t  x,  /* (i)   Q31: normalized value (1.0 > x >= 0.5) */
             int16_t *x_e /* (i/o) Q0 : pointer to exponent */
);
...
#ifdef USE_KISS_FFT
void fft16(int32_t *re, int32_t *im, int16_t s);
#endif

#define LC3_cfft_MAX_LENGTH 384
void LC3_cfft(int32_t *re, int32_t *im, int16_t sizeOfFft, int16_t s, int16_t *scale, int32_t *x);
void LC3_rfftN(int32_t *re, int16_t sizeOfFft, int16_t *scale, int8_t *scratchBuffer);
void LC3_irfftN(int32_t *re, int16_t sizeOfFft, int16_t *scale, int8_t *scratchBuffer);
