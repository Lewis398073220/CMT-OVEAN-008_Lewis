...
#define STATIC_ASSERT_1(cond) STATIC_ASSERTI(cond, __LINE__)
...
/* NOISE FILLING */
#define NOISEFILLWIDTH_10MS 3
#define NOISEFILLSTART_10MS 24
...
extern int32_t fix_empty_translation_unit_warning;
