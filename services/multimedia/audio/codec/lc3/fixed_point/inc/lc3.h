...
LC3_Error lc3_dec(LC3_Dec *decoder, void *scratch, void *input_bytes, int32_t num_bytes, void **output_samples, int32_t bitdepth, int32_t bfi_ext);
/*! \} */
#endif /* LC3 */
