                             ...
                             uint16_t max_length)
{
    ...
    diss_env->req_conidx    = conidx;
    diss_env->req_user_lid  = user_lid;
    diss_env->req_token     = token;
    if(status == GAP_ERR_NO_ERROR)
    {
        struct diss_value_req_ind *req = KE_MSG_ALLOC(DISS_VALUE_REQ_IND,
                                                      TASK_APP,
        ...
        switch(att_idx)
        {
            ...
            case DIS_IDX_MODEL_NB_STR_VAL:
                req->value = DIS_MODEL_NB_STR_CHAR;
                break;
            case DIS_IDX_SERIAL_NB_STR_VAL:
                req->value = DIS_SERIAL_NB_STR_CHAR;
                break;
            case DIS_IDX_HARD_REV_STR_VAL:
                req->value = DIS_HARD_REV_STR_CHAR;
                break;
            case DIS_IDX_FIRM_REV_STR_VAL:
                req->value = DIS_FIRM_REV_STR_CHAR;
                break;
            case DIS_IDX_SW_REV_STR_VAL:
                req->value = DIS_SW_REV_STR_CHAR;
                break;
            case DIS_IDX_SYSTEM_ID_VAL:
                req->value = DIS_SYSTEM_ID_CHAR;
                break;
            case DIS_IDX_IEEE_VAL:
                req->value = DIS_IEEE_CHAR;
                break;
            case DIS_IDX_PNP_ID_VAL:
                req->value = DIS_PNP_ID_CHAR;
                break;
            default:
                ASSERT_ERR(0);
                break;
       }
       diss_env->req_val = req->value;
...

{
    ...
    ASSERT(diss_env,"diss_env is NULL!");
 ...
 ****************************************************************************************
 */
static void diss_create(prf_data_t* p_env, uint8_t conidx, bool is_le_con)
{
    /* Nothing to do */
}
