                     ...
                     const tipc_ndcs_content_t* p_ndcs, const tipc_rtus_content_t* p_rtus)
{
    ...
    if(p_tipc_env != NULL)
    {
        if ((conidx < BLE_CONNECTION_MAX) && (p_tipc_env->p_env[conidx] == NULL))
        {
            ...
            p_tipc_env->p_env[conidx] = (struct tipc_cnx_env *) ke_malloc(sizeof(struct tipc_cnx_env), KE_MEM_PROFILE);
                          ...
                          const void* p_params, const tipc_cb_t* p_cb)
{
    ...
    do
    {
        ...
        p_tipc_env = (tipc_env_t*) ke_malloc(sizeof(tipc_env_t), KE_MEM_PROFILE);
