...
/// Minimum time of setting RPA Timeout
/// Minimum value 1s
#define GAP_RPA_TIMEOUT_MIN                             (0x0001)
/// Maximum time of setting RPA Timeout
/// 0xA1B8 (approximately 11.5 hours)
#define GAP_RPA_TIMEOUT_MAX                             (0xA1B8)
...
#if (BLE_GAF)
#define BLE_GATT_USER_NB            (11 + BLE_GATT + BLE_GATT_CLI) // 2 users reserved for GATT and GAP services / clients
