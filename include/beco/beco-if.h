...
#ifndef BECO_INLINE
#define BECO_INLINE static inline __attribute__ ((__always_inline__, __gnu_inline__, __artificial__))
#endif
...
{
    BECO_CDP_IMM(OPC_SETFFTCONF, BECO_I12_TO_CP_DMN(fc));
}
...
{
    BECO_MCRR_RR(_CPNUM, OPC_WRFFT, v32_0, v32_1, 0);
}
